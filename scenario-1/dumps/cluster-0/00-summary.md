...
- Namespace: `echo`
- Service name: `echo`
- Cluster role: **tier1** (matched Tier1Gateway CR istio-system/tier1-echo-gw serving echo.tetrate.io)
- Collected: 2026-06-01T10:48:46Z

## What was found

- Local Service: no
- Backing pods: 0 []
- Gateway pods: 1 [tier1/tier1-gateway-596d499c9c-sj9tb]
...
- XCP workspace(s): [passthrough-ws]
- XCP config CRs: 11
