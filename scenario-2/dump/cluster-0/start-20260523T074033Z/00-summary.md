...
- Cluster role: **tier1** (matched Tier1Gateway CR istio-system/tier1-echo-term-gw)
- Collected: 2026-05-23T07:40:33Z

## What was found

- Local Service: no
- Backing pods: 0 []
- Gateway pods: 1 [tier1-term/tier1-term-gateway-86f85c75f8-np28c]
- Istiod pods: 1 [istio-system/istiod-stable-65bd95ccc-pqdvh]
- XCP edge pods: 1 [istio-system/edge-668cdd6dc9-r9jpw]
- Matched Istio CRs: 17
  - VirtualService tier1-term/tier1-echo-term-gw-echo
  - Gateway tier1-term/tier1-echo-term-gw
  - DestinationRule tier1-term/tier1-tier1-echo-term-gwecho-term-tetrate-io
  ...
  - EnvoyFilter tier1-term/default-allow-tier1-echo-term-gw-external-batch0
  - EnvoyFilter tier1-term/default-upstream-traffic-setting
  - EnvoyFilter tier1-term/tier1-term-gg-default-upstream-traffic-setting
...
- XCP config CRs: 10
  ...
  - Workspace xcp-system/term-ws
  - GlobalSetting istio-system/global
  - GlobalSetting xcp-system/global
  - GatewayGroup istio-system/tier1-term-gg
  - GatewayGroup xcp-system/tier1-term-gg
  - GatewayGroup xcp-system/tier2-term-gg
  - IngressGateway xcp-system/echo-t2-term-gw
  - Tier1Gateway istio-system/tier1-echo-term-gw
  - Tier1Gateway xcp-system/tier1-echo-term-gw
...
- `istio-config` (02-istio-config): ok, 17 file(s)
- `istiod` (05-istiod): ok, 6 file(s)
- `k8s` (04-k8s): ok, 1 file(s)
- `xcp-config` (03-xcp-config): ok, 10 file(s)
