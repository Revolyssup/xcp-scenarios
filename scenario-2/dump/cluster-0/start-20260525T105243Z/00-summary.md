...
- Collected: 2026-05-25T10:52:43Z

## What was found

- Local Service: no
- Backing pods: 0 []
- Gateway pods: 1 [tier1-term/tier1-term-gateway-86f85c75f8-pxtbd]
- Istiod pods: 1 [istio-system/istiod-stable-65bd95ccc-pqdvh]
- XCP edge pods: 1 [istio-system/edge-668cdd6dc9-r9jpw]
- Matched Istio CRs: 19
  ...
  - IstioOperator istio-system/xcpgw-tier1-term-gateway
- XCP config CRs: 11
...
- `istio-config` (02-istio-config): ok, 19 file(s)
