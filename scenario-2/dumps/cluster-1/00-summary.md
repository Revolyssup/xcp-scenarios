...
- Collected: 2026-06-01T10:49:34Z

## What was found

- Local Service: yes
- Backing pods: 1 [echo-term/echo-term-58c79569c6-mqc2d]
- Gateway pods: 2 [echo-term/echo-term-gateway-6bc8b5ffdd-j92kt transit/transit-tier1-gateway-9c6668f8-wdbmx]
...
- XCP workspace(s): [term-ws transit-ws]
- XCP config CRs: 8
...
- `istiod` (05-istiod): ok, 10 file(s)
- `k8s` (04-k8s): ok, 4 file(s)
- `xcp-config` (03-xcp-config): ok, 8 file(s)
