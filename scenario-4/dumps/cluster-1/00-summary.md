...
- Namespace: `echo-tr`
- Service name: `echo`
- Cluster role: **tier1** (matched unified Gateway CR istio-system/transit-mid-gw acting as tier-1 (http[transit-hop] transit/trafficMode=TRANSIT) serving echo.echo-tr.svc.cluster.local)
- Collected: 2026-06-01T10:51:27Z

## What was found

- Local Service: no
- Backing pods: 0 []
- Gateway pods: 1 [transit/transit-tier1-gateway-9c6668f8-wdbmx]
- Istiod pods: 1 [istio-system/istiod-stable-b4c7c467b-2sqsx]
- XCP edge pods: 1 [istio-system/edge-64894b7864-qthr9]
- Matched Istio CRs: 16
  - VirtualService transit/transit-mid-gw-transit-hop
  - Gateway transit/transit-mid-gw
  - DestinationRule transit/tier1-transit-mid-gwecho-echo-tr-svc-cluster-local
  ...
  - IstioOperator istio-system/xcpgw-transit-tier1-gateway
- XCP workspace(s): [transit-ws]
- XCP config CRs: 5
  - GlobalSetting istio-system/global
  - EdgeXcp istio-system/edgexcp
  - Workspace istio-system/transit-ws
  - GatewayGroup istio-system/transit-mid-gg
  - Gateway istio-system/transit-mid-gw
